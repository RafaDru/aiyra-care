...
### Suporte SRE — Cursor Automation (Fase B — Postgres)
...
- `CURSOR_SRE_SUPPORT_AUTOMATION_WEBHOOK_*` (ou fallback legado / Suporte Desenvolvimento) configurados

Console: coluna **Análise** + botões **Analisar** / **Concluir**. Estado persistido em `ops_alert_incidents` (migration **065**) — sobrevive restart do ops-console. Aplicar: `node packages/api/scripts/apply-migration-065.mjs`. Playbook: `docs/ops/automations/ops-alert-investigator.prompt.md`.
