...
const API_ROUTE_PATTERN =
  '^/(patients|documents|exams|exam-orders|vaccines|medications|medication-administrations|allergies|growth-records|medical-records|diagnoses|authorizations|sessions|roadmap|integration-links|scraper|plan-memberships|handwriting-credits|scheduled-events|billing|compliance|calendar|health-threads|health|auth|project|care-places|clinical-export|graph|measurements|measurement-types|care-reminders|monitoring-export|emergency|relation-types|ava|llm|hygiene|telemetry)'
