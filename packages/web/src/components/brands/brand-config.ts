...
export const BRANDS: Record<BrandKey, BrandMeta> = {
  ...
  fleury_group: {
    ...
    accent: '#dbeafe',
    color: '#EA1B23',
    logoSrc: '/brands/fleury/grupo-fleury.svg',
    logoSquare: '/brands/fleury/grupo-fleury.svg',
    logoBanner: '/brands/fleury/grupo-fleury.svg',
    logoBg: '#ffffff',
    cardHeaderBg: '#ffffff',
    cardHeaderLogoMaxHeight: 44,
    logoFrame: { width: 48, height: 48 },
    integrationsAvatar: {
      src: '/brands/fleury/grupo-fleury.svg',
      bg: '#ffffff',
      fit: 'contain',
      frame: { width: 48, height: 48 },
    },
