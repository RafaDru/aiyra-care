...
/** Palavras-chave que indicam telemedicina/telesaúde. */
export const TELEMEDICINA_KEYWORDS = [
  'TELEMEDICINA', 'TELECONSULTA', 'TELESSAÚDE', 'TELESSAUDE', 'ATENDIMENTO REMOTO',
]

/** Palavras-chave que indicam pronto-socorro/urgência. */
export const PRONTO_SOCORRO_KEYWORDS = [
  'PRONTO SOCORRO', 'PSOC', 'PRONTO ATENDIMENTO', 'URGENCIA', 'EMERGENCIA',
  'CONSULTA DE URGENCIA', 'CONSULTA DE PS', 'CONSULTA EM PRONTO SOCORRO',
]

/** Palavras-chave que indicam retorno. */
export const RETORNO_KEYWORDS = [
  'RETORNO', 'CONSULTA DE RETORNO',
]

/** Palavras-chave que indicam consulta. */
export const CONSULTA_KEYWORDS = [
  'CONSULTA', 'PRIMEIRA VEZ', 'PRIMEIRA CONSULTA', 'CONSULTA MEDICA',
  'CONSULTA EM CLINICA', 'ATENDIMENTO AMBULATORIAL', 'PED', 'PEDIATRIA',
