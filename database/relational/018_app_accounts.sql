-- Identidade interna desacoplada do provedor de auth (Supabase hoje; migrável depois)
...
COMMENT ON TABLE app_accounts IS 'Identidade canônica do app; auth_subject = auth.users.id no Supabase.';
COMMENT ON TABLE patient_memberships IS 'Quem pode ver/editar cada paciente (guardian, etc.).';
